    ...
    vec![
        FormulaEntry {
            ...
            variants: &[SolveVariant {
                ...
                inputs: &[
                    VarDef { symbol: "V_REF", name: "Reference voltage", unit: "V",   default: 5.0 },
                    VarDef { symbol: "PGA",   name: "PGA gain",          unit: "V/V", default: 1.0 },
                ],
                output_unit: "V",
                compute: |v| v[0] / v[1],
            }],
        ...
        FormulaEntry {
            ...
            variants: &[SolveVariant {
                ...
                inputs: &[
                    VarDef { symbol: "FSR", name: "Full-scale range", unit: "V",    default: 5.0  },
        ...
        FormulaEntry {
            ...
            variants: &[SolveVariant {
                ...
                inputs: &[
                    VarDef { symbol: "V_in", name: "Input voltage",   unit: "V",    default: 2.5  },
                    VarDef { symbol: "FSR",  name: "Full-scale range",unit: "V",    default: 5.0  },
                    VarDef { symbol: "n",    name: "Resolution",      unit: "bits", default: 12.0 },
                ],
                output_unit: "codes",
        ...
        FormulaEntry {
            ...
            variants: &[
                ...
                SolveVariant {
                    ...
                    inputs: &[
                        VarDef { symbol: "SNR", name: "SNR", unit: "dB", default: 74.0 },
                    ],
                    output_unit: "bits",
        ...
        FormulaEntry {
            ...
            variants: &[SolveVariant {
                ...
                inputs: &[
                    VarDef { symbol: "V_dist", name: "RMS distortion", unit: "V", default: 50e-6 },
                    VarDef { symbol: "V_sig",  name: "RMS signal",     unit: "V", default: 1.76  },
                ],
                output_unit: "%",
        ...
        FormulaEntry {
            ...
            variants: &[SolveVariant {
                ...
                inputs: &[
                    VarDef { symbol: "V_sig",  name: "RMS signal",     unit: "V", default: 1.76  },
                    VarDef { symbol: "V_noise",name: "RMS noise",      unit: "V", default: 100e-6},
                    VarDef { symbol: "V_dist", name: "RMS distortion", unit: "V", default: 50e-6 },
                ],
                output_unit: "dB",
                compute: |v| {
                    20.0 * (v[0] / (v[1] * v[1] + v[2] * v[2]).sqrt()).log10()
                },
            }],
        },
        FormulaEntry {
            ...
            variants: &[
                SolveVariant {
                    ...
                    inputs: &[
                        VarDef { symbol: "SINAD", name: "SINAD", unit: "dB", default: 83.9 },
                    ],
                    output_unit: "bits",
                    compute: |v| (v[0] - 1.76) / 6.02,
                },
                SolveVariant {
                    ...
                    inputs: &[
                        VarDef { symbol: "ENOB", name: "ENOB", unit: "bits", default: 13.65 },
                    ],
                    output_unit: "dB",
        ...
        FormulaEntry {
            ...
            variants: &[SolveVariant {
                ...
                inputs: &[
                    VarDef { symbol: "N",    name: "ADC resolution",    unit: "bits", default: 24.0 },
                    VarDef { symbol: "pp_n", name: "Peak-to-peak noise",unit: "LSB",  default: 7.0  },
                ],
                output_unit: "bits",
        ...
        FormulaEntry {
            ...
            variants: &[SolveVariant {
                ...
                inputs: &[
                    VarDef { symbol: "N",      name: "ADC resolution",  unit: "bits", default: 24.0 },
                    VarDef { symbol: "rms_n",  name: "RMS noise",       unit: "LSB",  default: 1.06 },
                ],
                output_unit: "bits",
                compute: |v| (2f64.powi(v[0] as i32) / v[1]).log2(),
            }],
        ...
        FormulaEntry {
            ...
            variants: &[SolveVariant {
                ...
                inputs: &[
                    VarDef { symbol: "N", name: "Bits of accuracy", unit: "bits", default: 12.0 },
                ],
                output_unit: "τ",
        ...
        FormulaEntry {
            ...
            variants: &[SolveVariant {
                ...
                inputs: &[
                    VarDef { symbol: "V_FSR", name: "Full-scale range", unit: "V", default: 5.0 },
                ],
                output_unit: "V",
        ...
        FormulaEntry {
            ...
            variants: &[SolveVariant {
                ...
                inputs: &[
                    VarDef { symbol: "V_nADC", name: "ADC noise (Vrms)",  unit: "V", default: 100e-6 },
                    VarDef { symbol: "V_nAmp", name: "Amp noise (Vrms)",  unit: "V", default: 50e-6  },
                    VarDef { symbol: "V_nRef", name: "Ref noise (Vrms)",  unit: "V", default: 30e-6  },
                ],
                output_unit: "V",
        ...
        FormulaEntry {
            ...
            variants: &[SolveVariant {
                ...
                inputs: &[
                    VarDef { symbol: "f_in",    name: "Input frequency", unit: "Hz", default: 1e6   },
                    VarDef { symbol: "t_jitter",name: "Clock jitter",    unit: "s",  default: 1e-12 },
                ],
                output_unit: "dB",
        ...
        FormulaEntry {
            ...
            variants: &[SolveVariant {
                ...
                inputs: &[
                    VarDef { symbol: "f_in",    name: "Input frequency",  unit: "Hz", default: 1e6   },
                    VarDef { symbol: "t_jitter",name: "Clock jitter",     unit: "s",  default: 1e-12 },
                    VarDef { symbol: "OSR",     name: "Oversampling ratio",unit: "",  default: 16.0  },
                ],
                output_unit: "dB",
                compute: |v| {
                    -20.0 * (2.0 * std::f64::consts::PI * v[0] * v[1]).log10()
                        + 10.0 * v[2].log10()
                },
            }],
        },
