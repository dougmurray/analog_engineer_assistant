    ...
    vec![
        ...
        FormulaEntry {
            ...
            variants: &[
                SolveVariant {
                    ...
                    inputs: &[
                        VarDef { symbol: "code", name: "Input code",      unit: "",     default: 2048.0 },
                        VarDef { symbol: "FSR",  name: "Full-scale range",unit: "V",    default: 5.0    },
                        VarDef { symbol: "n",    name: "Resolution",      unit: "bits", default: 12.0   },
                    ],
                    output_unit: "V",
        ...
        FormulaEntry {
            ...
            variants: &[SolveVariant {
                ...
                inputs: &[
                    VarDef { symbol: "m_meas",  name: "Measured slope",unit: "V/code", default: 1.22e-3  },
                    VarDef { symbol: "m_ideal", name: "Ideal slope",   unit: "V/code", default: 1.221e-3 },
                ],
                output_unit: "%",
        ...
        FormulaEntry {
            ...
            variants: &[SolveVariant {
                ...
                inputs: &[
                    VarDef { symbol: "V_offset", name: "Offset error", unit: "LSB", default: 0.5  },
                    VarDef { symbol: "V_gain",   name: "Gain error",   unit: "LSB", default: 0.5  },
                    VarDef { symbol: "INL",      name: "INL error",    unit: "LSB", default: 1.0  },
                ],
                output_unit: "LSB",
